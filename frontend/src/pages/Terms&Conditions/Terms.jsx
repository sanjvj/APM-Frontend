    ...
    <div>
      ...
      <div className="m-8 lg:mx-auto lg:max-w-screen-xl items-center">
        ...
        <p className="mb-2 font-[400px] text-[14px]  text-[#606060]">
          ...
          province of residence and you have given us your consent to allow any
          of your minor dependents to use this site.<br></br>
        ...
        <p className="mb-2 font-[400px] text-[14px]  text-[#606060]">
          ...
          provided, without express written permission by us.<br></br>
        ...
        <p className="mb-2 font-[400px] text-[14px]  text-[#606060]">
          ...
          use of optional third-party tools.<br></br>
          ...
          the relevant third-party provider(s).<br></br>
        ...
        <p className="mb-2 font-[400px] text-[14px]  text-[#606060]">
          ...
          purpose, durability, title, and non-infringement. <br></br> In no case
          shall AnnapoornaMithai Sweets & Bakery, our directors, officers,
        ...
        <p className="mb-2 font-[400px] text-[14px]  text-[#606060]">
          ...
          you cease using our site.<br></br>
